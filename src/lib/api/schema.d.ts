...
export interface components {
  schemas: {
    ...
    ImportJobResponseStatusEnum:
      'uploaded' | 'validated' | 'failed' | 'running' | 'completed' | 'partially_completed';
    ImportJobValidate: {
      /** Format: uri */
      file: string;
    ...
    /**
     * @description Adding an existing user to this academy.
     *
  ...
  organizations_memberships_create: {
    ...
    requestBody: {
      content: {
        ...
        'application/x-www-form-urlencoded': components['schemas']['OrganizationMembershipCreate'];
        'multipart/form-data': components['schemas']['OrganizationMembershipCreate'];
      };
    };
    responses: {
      201: {
      ...
      /** @description Unknown user, already a member, or a role that is not assignable ('owner' never is). */
      400: {
        headers: {
          [name: string]: unknown;
        };
